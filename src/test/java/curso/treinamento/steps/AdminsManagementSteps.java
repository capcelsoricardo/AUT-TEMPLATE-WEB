...
public class AdminsManagementSteps {
	...
	public void que_eu_esteja_na_tela_Admins_Management() {										
		...
		Assert.assertTrue(adminsManagementPage.validar_pagina(), "Página Admins Management NÃO apresentada.");
	}
	...
	public void incluo_um_administrador(DataTable dataTable_) {
		...
		Assert.assertTrue(addAdminPage.validar_pagina(), "Página Add Admin NÃO apresentada.");
	...
	public void administrador_cadastrado_com_sucesso() {
		Assert.assertTrue(adminsManagementPage.validar_email_na_tabela(Helper.dataTable.get(0).get("Email")), "Usuário não cadastrado com sucesso.");		
	}
	...
	public void administrador_cadastrado_com_sucesso(String email) {
		Assert.assertTrue(adminsManagementPage.validar_email_na_tabela(email), "Usuário não cadastrado com sucesso.");
	}
	...
	public void altero_informacoes_do_administrador(DataTable dataTable) {
		...
		Assert.assertTrue(adminsManagementPage.validar_email_na_tabela(Helper.dataTable.get(0).get("Email Antigo")), "E-mail " + Helper.dataTable.get(0).get("Email Antigo") + " não encontrado para alteração.");
	...
	public void informacoes_do_administrador_alterada_com_sucesso() {
		Assert.assertTrue(addAdminPage.validar_mensagem_alteracao(), "Mensagem de alteração não apresentada.");
		Assert.assertTrue(adminsManagementPage.validar_email_na_tabela(Helper.dataTable.get(0).get("Email Novo")), " O administrador " + Helper.dataTable.get(0).get("Email Antigo")  + " não foi alterado para " + Helper.dataTable.get(0).get("Email Novo"));					
	}
	...
	public void administrador_excluido_com_sucesso(String email) {		
		Assert.assertFalse(adminsManagementPage.validar_email_na_tabela(email), "Administrador " + email + " não excluido!");
	}	
}